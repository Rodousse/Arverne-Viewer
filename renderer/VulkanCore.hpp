...
protected :
    ...
    static std::vector<char> readFile(const QString&  fileName); // Read the content of the spv file
...
public:
    ...
    void addRequiredExtensions(const char** extensions, uint32_t extensionCount); ///TODO Call by application
    void initVulkan();
