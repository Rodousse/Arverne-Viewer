#ifndef PHYSICAL_DEVICE_PROPERTIES_HPP
#define PHYSICAL_DEVICE_PROPERTIES_HPP
...
public:
    ...
    VkFormat findSupportedTilingFormat(const std::vector<VkFormat> &candidates, VkImageTiling tiling, VkFormatFeatureFlags features)const;
