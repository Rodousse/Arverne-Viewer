...
public:
    ...
    VkImageView createImageView(VkFormat format, VkImage image, VkImageAspectFlags aspectFlags, uint32_t mipLevels)const;
    ...
    void createImage(uint32_t width, uint32_t height, uint32_t mipLevels, VkSampleCountFlagBits numSamples, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags property, VkImage &image, VkDeviceMemory &imageMemory)const;
