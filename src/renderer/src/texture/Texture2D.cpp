...
//template <VkFormat format>
//void Texture2D<format>::generateMipmaps(VkImage image, VkFormat imageFormat, int32_t texWidth,
...
//template <VkFormat format>
//void Texture2D<format>::createSampler()
//{
...
//template <VkFormat format>
//void Texture2D<format>::createImage()
//{
...
//    tools::image::createImage(*pCore_, static_cast<uint32_t>(data_->width()),
...
//    tools::image::transitionImageLayout(*pCore_, image_,
//                                        tools::image::mapDataImageFormatToVkFormat(data::ImageFormat::RGBA8),
...
//template <VkFormat format>
//void Texture2D<format>::createImageView()
//{
...
//template <VkFormat format>
//const VkSampler& Texture2D<format>::sampler() const
//{
//    return sampler_;
//}

//template <VkFormat format>
//const VkImage& Texture2D<format>::image() const
//{
//    return image_;
//}

//template <VkFormat format>
//const VkImageView& Texture2D<format>::imageView() const
//{
//    return imageView_;
//}
